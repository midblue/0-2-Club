    ...
    <div class="mainbar">
      ...
      <div class="right">
        ...
        <a
          ...
          target="_blank"
        >
          <button class="low">{{ isMobile ? '' : 'Give ' }}Feedback</button>
        </a>
      </div>
    </div>
